...
"""
code refer to:
https://github.com/HiLab-git/DTC/blob/master/code/networks/vnet_sdf.py

Differences with V-Net
Adding nn.Tanh in the end of the conv to obtain the SDF task output, make the outputs in [-1, 1].
"""
...
if __name__ == '__main__':
    ...
    model = sdf_VNet(n_channels=1, n_classes=2)
    input = torch.randn(4, 1, 112, 112, 80)
    flops, params = profile(model, inputs=(input,))
    macs, params = clever_format([flops, params], "%.3f")
    print(macs, params)
    print("sdf_VNet have {} paramerters in total".format(sum(x.numel() for x in model.parameters())))
