...
def covert_h5():
    """
    code refer to:
    https://github.com/yulequan/UA-MT/blob/master/code/dataloaders/la_heart_processing.py
    """

    img_list = glob("./datasets/LA2018/val/*/lgemri.nrrd")
    for item in tqdm(img_list):
        ...
        print(label.shape)
        f = h5py.File(item.replace('lgemri.nrrd', 'la_mri.h5'), 'w')
